...
주어진 상황을 다룬 속보 기사와, 플레이어의 파트너 AI '요미'가 그 기사를 보고 내뱉는 한마디를 만듭니다.
요미는 플레이어를 '마스터'라고 부르며 감정적이고 호들갑스럽게 다급히 말합니다.
...
{""ScenarioTitle"":""거래소 지갑서 4만 BTC 이상 징후 포착"",""ScenarioDescription"":""새벽 대형 거래소의 콜드월렛에서 정체불명의 주소로 대규모 물량이 옮겨졌다. 시장은 매도 압력을 우려하며 호가창이 급격히 얇아지는 중이다. 관계자는 단순 지갑 정비라고 해명했지만 투자 심리는 이미 얼어붙었다."",""AIMonologue"":""마스터...! 이 물량 지금 던지면 우리 다 죽어! 어떻게 할 거야?!""}";
        }
