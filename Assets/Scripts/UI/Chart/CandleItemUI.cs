...
namespace FXOverdose.UI.Chart
{
    public class CandleItemUI : MonoBehaviour
    {
        ...
        private readonly Color bullishColor = new Color(0.133f, 0.773f, 0.369f, 1f); // #22C55E (녹색)
        private readonly Color bearishColor = new Color(0.937f, 0.267f, 0.267f, 1f); // #EF4444 (적색)
        private readonly Color bullishVolumeColor = new Color(0.133f, 0.773f, 0.369f, 0.6f);
        private readonly Color bearishVolumeColor = new Color(0.937f, 0.267f, 0.267f, 0.6f);
