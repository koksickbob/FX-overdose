> [!WARNING]
> **[DEPRECATED — 2026-08-12] 이 문서는 폐기되었습니다.**
> 미연시 자유 채팅(LLM) 시스템은 게임에서 제거되었습니다. 본 문서는 설계 히스토리 보존용이며 **현재 코드와 일치하지 않습니다**.
> 제거 범위와 대체 훅은 [DatingSim_FreeChat_Removal_Plan.md](../DatingSim_FreeChat_Removal_Plan.md) 를 참고하십시오.
